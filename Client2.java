...
public class Client2 {
    ...
    public void startClient() {
        ...
        Socket requestSocket ;         // πρίζα αιτήματος
        ...
        try {
            ...
            while(true) {
                ...
                System.out.println("File sent: " + msg);     ObjectInputStream objectInputStream = new ObjectInputStream(dataInputStream);
                ...
                for(Map.Entry<String,Results> entry:stats.getStats().entrySet()){
                    System.out.println(entry.getKey().toUpperCase()+": Average distance: "+entry.getValue().getTotalDistance()+" km , Average time: "+entry.getValue().getTime()/60+" min , Average elevation: "+entry.getValue().getEle()+" meters");
