...
public class WorkerNode2 {
    ...
    public WorkerNode2(String masterHost, int masterPort, int workerId) {
        ...
        try {
            ...
            while (true) {
                ...
                try{
                    ...
                    WorkerThread2 workerThread = new WorkerThread2(socket,chunk);
                    workerThread.start();
                    numThreads++;
    ...
    private class WorkerThread2 extends Thread {
        ...
        public WorkerThread2(Socket socket, Chunk chunk) {
            this.socket = socket;
            this.chunk = chunk;
        }
        ...
        public void run() {
            ...
            try {
                ...
                //Κάνουμε τους υπολογισμούς και κάνουμε map βάσει το αποτέλεσμα
                //Είναι κοινός πόρος οπότε τον κλειδώνουμε
        ...
        private Map<Integer,Float> Mapper(Chunk chunk) {
            ...
            //Πρέπει να στείλουμε πίσω στον Master τα intermediate result
            //
    ...
    private float distance(waypoint first, waypoint second) {
        int R=6371;//Η ακτίνα της γης σε χιλιόμετρα
    ...
    private float speed(double distance,double time){
